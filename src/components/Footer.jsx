...
export default class Header extends React.Component {
            ...
            <div className="col-lg-3  col-md-6 col-sm-6">
              <div className="single-footer-widget">
                ...
                <p>
                  ...
                  page of information, they would much rather look at a presentation and understand
  ...
  <div className="single-footer-widget mail-chimp">
    ...
    <ul className="instafeed d-flex flex-wrap">
      <li>
        <img src="src/images/i1.jpg" alt="" />
      </li>
      <li>
        <img src="src/images/i2.jpg" alt="" />
      </li>
      <li>
        <img src="src/images/i3.jpg" alt="" />
      </li>
      <li>
        <img src="src/images/i4.jpg" alt="" />
      </li>
      <li>
        <img src="src/images/i5.jpg" alt="" />
      </li>
      <li>
        <img src="src/images/i6.jpg" alt="" />
      </li>
      <li>
        <img src="src/images/i7.jpg" alt="" />
      </li>
      <li>
        <img src="src/images/i8.jpg" alt="" />
      </li>
    </ul>
  </div> 
</div> */}
          ...
          <div className="row footer-bottom d-flex justify-content-between align-items-center">
            <p className="col-lg-8 col-sm-12 footer-text m-0">
              ...
              template is made with <i className="fa fa-heart-o" aria-hidden="true" /> by{' '}
